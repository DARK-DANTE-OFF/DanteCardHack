...
# --- Animation d'introduction hacker ---
def hacker_intro(duration=5):
    hacking_messages = [
        "Brute forcing router credentials...",
        "Exploiting SQL injection on target...",
        "Bypassing security firewall...",
        "Gaining root access to server...",
        ...
        "Uploading backdoor to server...",
        "Scanning open ports on network...",
        "Launching DDoS attack vector...",
        "Finding vulnerabilities in system...",
        "Access granted to admin panel.",
        "Installing trojan horse...",
        "Tracking geolocation of IP...",
        "Reading secured communication logs...",
        "Cracking WPA2 Wi-Fi password...",
        "Erasing system logs to cover tracks..."
    ]

    start_time = time.time()
    while time.time() - start_time < duration:
        if random.random() < 0.3:
            print(Fore.LIGHTGREEN_EX + random.choice(hacking_messages))
        else:
